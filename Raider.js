...
const RaidRooms = ['353244652624805898', '336638617642467339', '349664336148561920', '349571799283138560', '335202620849258498', '336637868195840000', '336638223667167232', '336638256777003010', '342054368733822977', '349664694849634325', '328269963599151106', '328265358605811712', '342440523304402947']
...
function raid(time, poke, location, owner, guests = 1) {
  ...
  this.owner = tmpuser;
  this.expires = Date.now() + 7200000; //TODO: better expiration
  this.attendees = {};
  ...
  this.listAttendees = function () {
    let str = "";
    _.each(this.attendees, (attendee) => {
      str += tab + tab + attendee.count + tab + " - " + attendee.username + nl;
    });
    return str;
  }
